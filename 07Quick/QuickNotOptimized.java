public class QuickNotOptimized{
	...
	//     System.out.println(QuickNotOptimized.quickselect(test1,i));
	// }
	// for(int i=1;i<test2.length+1;i++){
	//     System.out.println(QuickNotOptimized.quickselect(test2,i));
	// }
	// for(int i=1;i<test3.length+1;i++){
	//     System.out.println(QuickNotOptimized.quickselect(test3,i));
	// }
	...
	// }
	//System.out.println(QuickNotOptimized.quickselect(test1,8));
	 // System.out.println(QuickNotOptimized.quickselect(test1,1));
	// int[]ary = { 2, 10, 15, 23, 0,  5};
	// for(int i=0;i<ary.length;i++){
	//     System.out.println(QuickNotOptimized.quickselect(ary,i));
	// }
